...
TEST_CASE( "Verify Application without splitting file in smaller chunks to fit memory input_test.csv against small Output" ) {
    //TimeStamp,Quantity,Price
    TradeFileHandler tfh("","input_test.csv","output_test.csv",false); //processLargeFileInChunks=false
